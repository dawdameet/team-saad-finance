...
import JonesRoi from './JonesRoi.jsx'

const TABS = ['Dashboard','Budget','Credit','Taxes','FinBot','Advisor','Watchlist','Jones\'s roi','Profile']
    ...
    <>
          ...
          <div>
            <button
              ...
              onClick={()=>{
                ...
                if(!ok) return;
                setSigningOut(true)
                try{ logout(); setAuthed(false); setToast('Signed out') } finally { setSigningOut(false) }
              }}
      ...
      <div className="container">
        ...
        <div style={{marginTop:16}}>
          ...
          {tab==='Watchlist' && <Watchlist onToast={setToast}/>}
          {tab==="Jones's roi" && <JonesRoi onToast={setToast}/>}
