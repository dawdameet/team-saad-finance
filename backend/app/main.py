...
from app.routes import auth, users, dashboard, investments, budget, credit, taxes, finbot, admin, advisor
from app.routes import roi as roi
from app.routes import watchlist as watchlist
